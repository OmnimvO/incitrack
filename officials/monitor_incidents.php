                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <?php foreach ($incidents as $index => $incident): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($incident['reporter_fname'] . ' ' . $incident['reporter_lname']) ?></td>
                                ...
                                <td><?= $incident['verified_by'] ? htmlspecialchars($incident['verified_by']) : '—' ?></td>
                                <td class="action-btns">
                                    <a href="view_incident.php?id=<?= $incident['incident_id'] ?>" class="btn btn-sm btn-info">View</a>
                                    <?php if ($_SESSION['user_type'] === 'official' || $_SESSION['user_type'] === 'tanod'): ?>
                                        <a href="verify_incident.php?id=<?= $incident['incident_id'] ?>" class="btn btn-sm btn-success">Verify</a>
                                    <?php endif; ?>
                                    <a href="delete_incident.php?id=<?= $incident['incident_id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this incident?')">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
