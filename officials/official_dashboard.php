...
<body>
  <div class="container">
    ...
    <aside class="sidebar">
      <div class="logo text-center" style="margin-left: auto; margin-right: auto; width: 60%;">
        <img src="../img/logos.png" alt="Logo" style="max-height: 100px;"> 
      </div>
      <div class="profile text-center">
        <img src="../img/official.png" alt="Profile Pic" class="img-fluid rounded-circle" style="width: 70px; height: 70px; margin-top: 20px;">
        <h3><?php echo htmlspecialchars($official['name']); ?></h3>
        <span class="badge bg-success"><?php echo htmlspecialchars($official['position']); ?></span>
      </div>
    ...
    <main class="main">
      <section class="intro">
        ...
        <a href="monitor.php" class="btn btn-success">View Reports</a>
      </section>
